...
wget http://repos.sakhaglobal.com/saikrishna/infowork/raw/master/aws/staging/id_rsa.pub
mv id_rsa.pub ~/.ssh/
chmod 644 ~/.ssh/id_rsa.pub
wget http://repos.sakhaglobal.com/saikrishna/infowork/raw/master/aws/staging/id_rsa
mv id_rsa ~/.ssh/
...
wget http://repos.sakhaglobal.com/saikrishna/infowork/raw/master/aws/staging/original-centos-mysql-server.sh
bash original-centos-mysql-server.sh
rm -rf original-centos-mysql-server.sh
wget http://repos.sakhaglobal.com/saikrishna/infowork/raw/master/aws/staging/ambari-server-setup.sh
