...
export app_path=http://54.221.70.148:8081/artifactory/infoworks-release/io/infoworks/release/2.2.0/infoworks-2.2.0.tar.gz
...
export password=$3
fqdn="$(cat /root/credentials | tail -n -1)"
...
_deploy_app(){
    ...
    namenode_hostname=$(cat /root/secondary)
