...
sudo wget https://infoworks-setup.s3.amazonaws.com/emr-configurations/emr-5.28.1/emr-apps.repo -P /etc/yum.repos.d/

sudo wget https://infoworks-setup.s3.amazonaws.com/emr-configurations/emr-5.28.1/emr-platform.repo -P /etc/yum.repos.d/

wget https://infoworks-setup.s3.amazonaws.com/emr-configurations/emr-5.28.1/ec2-packages.txt -P /home/ec2-user/
...
wget https://infoworks-setup.s3.amazonaws.com/emr-configurations/emr-5.28.1/emrconfigs-5.28.1-kerberos-tls.tar.gz


tar xf emrconfigs-5.28.1-kerberos-tls.tar.gz
