...
#_post_deploy_app_user_actions(){
#    source ${iw_home}/bin/env.sh

    #run ui startup script
 #   pushd ${IW_HOME}/apricot-meteor/apricot
 #       if [ -f main.js ]; then
 #           APRICOT_BASE_DIR=${IW_HOME}/apricot-meteor ${IW_HOME}/apricot-meteor/scripts/startup.sh
 #       fi
 #   popd
 ...
 #   eval cd /opt/infoworks/apricot-meteor/scripts/ && ./iw_migration.sh

#}
#export -f _post_deploy_app_user_actions
